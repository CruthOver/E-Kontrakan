...
<body>
	...
	<?php
		$sql = mysqli_query($conn, "SELECT * FROM rumah_kontrakan, perumahan where rumah_kontrakan.id_perum = perumahan.id_perum AND rumah_kontrakan.id_perum = 1");
